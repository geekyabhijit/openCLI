...
export class ToolRegistry {
  ...
  registerTool(tool: Tool): void {
    console.log(`🔧 DEBUG: Registering tool: ${tool.name} (schema name: ${tool.schema.name})`);
    ...
    console.log(`🔧 DEBUG: Tool registry now has ${this.tools.size} tools: [${Array.from(this.tools.keys()).join(', ')}]`);
  }
